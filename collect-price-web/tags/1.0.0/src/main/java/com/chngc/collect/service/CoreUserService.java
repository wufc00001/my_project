...
public class CoreUserService {
    ...
    public CoreUserVo getCoreUserVo(CoreUser user) {
        CoreUser user2 = coreUserMapper.getCoreUserByUserId(user.getUserId());
        CoreUserVo userVo = new CoreUserVo();
        String roleIds =  user2.getRoleIds()==null?"":user2.getRoleIds();
        String roleNames = coreRoleMapper.getRoleNames(roleIds.split(","));
        userVo.setRoleNames(roleNames);
        ConverterUtils.converterUserVo(user2,userVo);
        return userVo;
    }
