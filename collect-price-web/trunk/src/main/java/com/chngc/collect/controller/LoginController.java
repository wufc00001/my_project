...
public class LoginController extends BaseController{
    ...
    public Mono<ResponseResult> login(@RequestBody CoreUser coreUser,@Param("loginName") String loginName, @Param("password") String password, HttpServletRequest request,
                                      HttpServletResponse response) {
        // 判断  登录用户名和密码
        Permission pm = coreUserService.login(coreUser.getLoginName(),coreUser.getPassword());
        // 如果登录成功
